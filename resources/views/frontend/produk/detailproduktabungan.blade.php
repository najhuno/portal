		...
		<div class="row ">
				...
				<div class="single-news ">
					...
					<div class="news-body">
						<div class="news-content">
							<h3 class="news-title"><a href="{{ url('detailproduk/kredit/potpns') }}">TAMASDA</a></h3>
							...
							<a href="{{ url('detailproduk/kredit/potpns') }}" class="more">Lihat Selengkapnya <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
						</div>
					</div>
				</div>
				<!--/ End Single Blog -->
			...
			<div class="col-lg-4 col-md-6 col-12">
				...
				<div class="single-news ">
					...
					<div class="news-body">
						<div class="news-content">
							<h3 class="news-title"><a href="blog-single.html">TASIS</a></h3>
							<div class="news-text"><p>Produk tabungan yang diperuntukkan bagi para pelajar atau orang tua murid dan para guru untuk persiapan biaya pendidikan. Tabungan Siswa membantu perencanaan keuangan untuk memastikan kesiapan biaya pendidikan putra putri Anda.<br><br></p></div>
			...
			<div class="col-lg-4 col-md-6 col-12">
				...
				<div class="single-news ">
					...
					<div class="news-body">
						<div class="news-content">
							<h3 class="news-title"><a href="blog-single.html">TANAS</a></h3>
							<div class="news-text"><p>Perencanaan keuangan yang baik merupakan kunci untuk menikmati kehidupan di masa yang akan datang. Tabungan Anak Sekolah akan membantu wujudkan impian anda. Tabungan berjangka dengan berbagai keuntungan dan bebas biaya apapun.</p><br></div>
							<a href="blog-single.html" class="more">Lihat Selengkapnya <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
						</div>
					</div>
				</div>
