				...
				<div class="row">
					<div class="col-12">
						<div class="bread-inner">
							...
							<!-- Bread Title -->
							<div class="bread-title"><h2>Prestasi & Penghargaan</h2></div>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
						<div class="section-title default text-center">
							<div class="section-top">
								<h1><span>Project</span><b>Prestasi &amp; Penghargaan</b></h1>
							</div>
							<div class="section-bottom">
								<div class="text">
									<p>Kinerja Perumda BPR Kabupaten Cirebon telah mendapatkan pengakuan baik dari Pemerintah Kabupaten Cirebon, Media Bisnis, Lembaga Non-Bank dan juga Lembaga Survei Bisnis Indonesia</p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="portfolio-main">
							<div id="portfolio-item" class="portfolio-item-active">
								...
								<div class="cbp-item business animation">
									<div class="single-portfolio">
										<div class="portfolio-head overlay">
											<img src="img/prestasi/pa_3.png" alt="#">
								...
								<div class="cbp-item seo consulting">
									<div class="single-portfolio">
										<div class="portfolio-head overlay">
											<img src="img/prestasi/pa_2.png" alt="#">
											<a class="more" href="#"><i class="fa fa-long-arrow-right"></i></a>
										</div>
										<div class="portfolio-content">
								...
								<div class="cbp-item marketing seo">
									<div class="single-portfolio">
										<div class="portfolio-head overlay">
											<img src="img/prestasi/pa_1.png" alt="#">
											<a class="more" href="#"><i class="fa fa-long-arrow-right"></i></a>
										</div>
										<div class="portfolio-content">
								...
								<div class="cbp-item marketing seo">
									<div class="single-portfolio">
										<div class="portfolio-head overlay">
											<img src="img/prestasi/pa_4.png" alt="#">
											<a class="more" href="#"><i class="fa fa-long-arrow-right"></i></a>
										</div>
										<div class="portfolio-content">
											<h4>BPR Awards 2017</h4>
											<p>Infobank, 2016</p>
										</div>
									</div>
								</div>
								...
								<div class="cbp-item marketing seo">
									<div class="single-portfolio">
										<div class="portfolio-head overlay">
											<img src="img/prestasi/pa_5.png" alt="#">
											<a class="more" href="#"><i class="fa fa-long-arrow-right"></i></a>
										</div>
										<div class="portfolio-content">
											<h4>BPR Awards 2016</h4>
											<p>Infobank, 2015</p>
										</div>
									</div>
								</div>
								...
								<div class="cbp-item marketing seo">
									<div class="single-portfolio">
										<div class="portfolio-head overlay">
											<img src="img/prestasi/pa_6.png" alt="#">
											<a class="more" href="#"><i class="fa fa-long-arrow-right"></i></a>
										</div>
										<div class="portfolio-content">
											<h4>BPR Awards 2014</h4>
											<p>Infobank, 2013</p>
										</div>
									</div>
								</div>
								...
								<div class="cbp-item marketing seo">
									<div class="single-portfolio">
										<div class="portfolio-head overlay">
											<img src="img/prestasi/pa_7.png" alt="#">
											<a class="more" href="#"><i class="fa fa-long-arrow-right"></i></a>
										</div>
										<div class="portfolio-content">
											<h4>BPR Awards 2013</h4>
											<p>Infobank, 2012</p>
										</div>
									</div>
								</div>
								...
								<div class="cbp-item marketing seo">
									<div class="single-portfolio">
										<div class="portfolio-head overlay">
											<img src="img/prestasi/pa_8.png" alt="#">
											<a class="more" href="#"><i class="fa fa-long-arrow-right"></i></a>
										</div>
										<div class="portfolio-content">
											<h4>BPR Awards 2011</h4>
											<p>Infobank, 2010</p>
										</div>
									</div>
								</div>
