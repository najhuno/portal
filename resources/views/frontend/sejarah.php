	...
	<body id="bg">
				...
				<div class="row">
					<div class="col-12">
						<div class="bread-inner">
							...
							<!-- Bread Title -->
							<div class="bread-title"><h2>Sejarah</h2></div>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="hero-slider style1">
			<div class="home-slider">
				<!-- Single Slider -->
				<div class="single-slider" style="background:url(img/timeline1.png)">
					<div class="container">
						<div class="row">
				...
				<!-- Single Slider -->
				<div class="single-slider" style="background:url(img/timeline2.png)">
					<div class="container">
						<div class="row">
							<div class="col-lg-7 col-md-8 col-12">		
